...
public class ProcedureElement extends AbstractCompositeNode implements 
	...
	public static ProcedureElement getPrototype() {
		
		if (prototype == null) prototype = new ProcedureElement();
	...
	*/
	...
	public Object clone() {
		...
		ProcedureElement cloned = (ProcedureElement) super.clone();
		
		if (procedureData != null) {
			cloned.procedureData = (UmlProcedure) procedureData.clone();
			cloned.procedureData.addModelElementListener(cloned);
		}
	...
	*/
	...
	public void setModelElement(UmlProcedure aModelElement) {
		
		procedureData = aModelElement;
		
		if (procedureData != null) {
			procedureData.addModelElementListener(this);
		}
	}
